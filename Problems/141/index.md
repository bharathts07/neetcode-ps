...
O(n), where n is the number of nodes in the list. In the worst case, the hare will traverse the entire list.

### Space Complexity

O(1), as we only use two pointers, which use constant space.
